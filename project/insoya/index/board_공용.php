    ...
    ?>
        ...
        ?>
                    <tr>
                        ...
                        <td><a href="./view_공용.php?b_idx=<?=$b_idx?>"><?=$b_title?></a><?=$reply_cnt_str?><?=$b_file_str?></td>
                        <td><?=$b_hit?></td>
                        <td><?=$b_regdate?></td>
                    </tr>
        <?php
        ...
        ?>
                ...
                <?php
                    ...
                    for($i=1;$i<=$pagenums;$i++){
                        echo "<a href='./board_공용.php?pagenum=".$i."'>".$i."</a> ";
                    }
                ?>
                </p>
                <input type="submit" value="글쓰기" onclick="location.href='./write_공용.php'">
