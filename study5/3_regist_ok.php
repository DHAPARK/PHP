<?php
    ...
    if(!$conn){
        ...
        mem_address2,mem_address3) VALUES ('$userid','$userpw','$username','$email','$hobby','$ssn1','$ssn2',
        '$sipcode','$address1','$address2','$address3')";
        echo($sql);
        $result = mysqli_query($conn,$sql);
        //echo "<script>alert('회원가입 성공!'); location href='3_login.php';</script>";
    }
